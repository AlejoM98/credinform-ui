    ...
    <div className = {classes.root} >
      <Grid container spacing = {3}>
        ...
        <Grid item xs= {12} sm={4} md={4} lg={4} xl={4}>
          <CardsHaeder icono={<SupervisorAccountIcon className={classes.iconos}/>} titulo="Solicitadas este mes" texto="40" color="rgba(255,127,0,1)" font="white"/>
        </Grid> 
        <Grid item xs= {12} sm={4} md={4} lg={4} xl={4}>
          <CardsHaeder icono={<RestoreIcon className={classes.iconos}/>} titulo="Polizas Promedio Cierres" texto="19" color="rgba(255,127,0,1)" font="white"/>
        </Grid> 
        <Grid item xs= {12} sm={4} md={4} lg={4} xl={4}>
          <CardsHaeder icono={<RestoreIcon className={classes.iconos}/>} titulo="Polizas Promedio Ejcucion" texto="20" color="rgba(255,127,0,1)" font="white"/>
        </Grid>
