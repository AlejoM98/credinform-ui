...
class Kanban2 extends React.PureComponent <{}, IKanbanProps>{
        ...
        return (
            <div>
                <JqxKanban ref={this.myKanban}
                    // @ts-ignore
                    width={getWidth('kanban')} height={500} source={this.state.source}
                    columns={this.state.columns} resources={this.state.resources} />
                <br />
                <JqxButton style={style} onClick={this.addItemBtnOnClick} width={90}>Add Item</JqxButton>
                <JqxButton ref={this.myRemoveItemBtn} style={style} onClick={this.removeItemBtnOnClick} width={90}>Remove Item</JqxButton>
                <JqxButton ref={this.myUpdateItemBtn} style={style} onClick={this.updateItemBtnOnClick} width={90}>Update Item</JqxButton>
            </div>
        );
    }
